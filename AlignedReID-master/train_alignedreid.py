...
parser.add_argument('--save-dir', type=str, default='/home/ubuntu/Documents/huawei/log')
parser.add_argument('--use_cpu', action='store_true', help="use cpu")
parser.add_argument('--gpu-devices', default='8', type=str, help='gpu device ids for CUDA_VISIBLE_DEVICES')
